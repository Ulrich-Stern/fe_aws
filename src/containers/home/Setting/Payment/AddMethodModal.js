...
class AddMethodModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            payment_type: 'atm',
        ...
        try {
            ...
            if (check) {
                ...
                // successful case
                    ...
                    toast.success('save payer successful');
                    // update
                    this.props.refreshDataPayerFromParent();
                    // turn off modal
...
export default connect(mapStateToProps, mapDispatchToProps)(AddMethodModal);
